package com.hyunjin.blog.config;
...
import com.hyunjin.blog.config.auth.PrincipalDetailService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	// 해당 password가 뭘로 해쉬가 되어있는지 알아야
	// 같은 해쉬로 암호화해서 DB에 있는 해쉬를 비교할 수 있음.
